  ...
  return (
    <Container id="about">
      <Inner className={isDark ? "dark" : "light"}>
        <InnerBox>
          <TextBox>
            Hello 👋! I’m Ade-Ajayi Abolaji, Full Stack Developer with 4+ years
            of experience in all stages of the development cycle for dynamic web
            ...
            HTML5, CSS3, JavaScript, ES6, jQuery, Bootstrap, Material UI,
